...
inline SemaphoreHandle_t xSemaphoreCreateMutex() { if(semaphore_fail) return nullptr; return new FakeSemaphore{{},false,0,{}}; }
inline SemaphoreHandle_t xSemaphoreCreateRecursiveMutex() { if(semaphore_fail) return nullptr; return new FakeSemaphore{{},true,0,{}}; }
